...
class Controller_Caiwu_Yf_Fukuan extends Tmis_Controller {
    ...
    function __construct() {
        ...
        $this->fldMain = array(
            ...
            // 'supplierId' => array('title' => '应付对象', 'type' => 'select', 'value' => '','model'=>'Model_Jichu_Supplier'),
            'supplierId' => array(
                'title' => '应付对象',
                'type' => 'Popup',
                'name' => 'supplierId',
                'url'=>url('Jichu_Jiagonghu','Popup'),
                'textFld'=>'compName',
                'hiddenFld'=>'id',
            ),
    ...
    function actionRight() {
        ...
        if($arr['compName']!='')$sql.=" and a.compName like '%{$arr['compName']}%'";
        ...
        $smarty->assign('page_info',$page->getNavBar($this->_url($_GET['action'],$arr)));
