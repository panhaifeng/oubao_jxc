  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
      <tr>
        ...
        <td><input name="datePatch" type="text" id="datePatch" value="{$smarty.now|date_format:'%Y-%m-%d'}"/>
        时间：<input name="timePatch" type="text" id="timePatch" value="{$smarty.now|date_format:'%H:%M:%S'}"/></td>
        </tr>      
      <tr>
...
<h3>测试工具</h3>
<form action='?controller=Dbchange&action=getQrcodeByOrdercode' method="post">根据orderCode快速得到相关卷号
<input type='text' value='' placeholder="订单号" name='orderCode' />
