...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
			...
			$('tr[id="trRole"]').click(function(){
				if(_cRow) _cRow.style.backgroundColor='#fff';
				_cRow = this;
				_cRow.style.backgroundColor = '#C1DDF1';
	...
	#role{border-bottom: #c3daf9 1px solid; border-left: #c3daf9 1px solid; width: 200px; height: 500px; overflow: auto; border-top: #c3daf9 0px solid; border-right: #c3daf9 1px solid; float:left;margin-top:10px; margin-left:5px;}
...
<body>
    <div id="role">
      <table class='Juese table'>
            <tr>
              <td style="background:#5BC0DE; padding-left:5px;border-bottom:1px solid #fff;color:#fff;">
			  		<strong>选择组</strong>(单击进行设置)
			  </td>
            </tr>
            {foreach from=$rowRole item='item'}
            <tr onMouseOver="if(this!=_cRow) this.style.backgroundColor='#5BC0DE'" onMouseOut="if(this!=_cRow) this.style.backgroundColor='#fff'" bgcolor="#fff" id='trRole' val="{$item.id}">
    ...
    <div style="border-bottom: #c3daf9 1px solid; border-left: #c3daf9 1px solid; width: 250px; height: 500px; overflow: auto; border: #c3daf9 1px solid; float:left; margin-left:10px;margin-top:10px;">
        <div id="tree" style="text-align:left"></div>
    </div>
	<div style="float:left; margin-top:10px; margin-left:5px;" align="left">
      <input type="button" name="button" id="btnSub" value="设置权限" class="btn btn-info" style="width:100px; height:30px;">
