...
*  Remark :jeff
\*********************************************************************/
function _ctlBtPopupEdit($name,$params){
    //传递的参数
  ...
  //$js_function = $params['js_function']?$params['js_function']:'';
    ...
    $html .= '
    <div class="input-group input-group-sm clsPopEdit">
      <input name=\'textBox\' class=\'form-control input-sm\' type=\'text\' id=\'textBox\' value="'.$text.'" disabled />
      <span class="input-group-btn" id="btnPopEditEdit" name="btnPopEdit" url="'.$url.'" textFld="'.$textFld.'" hiddenFld="'.$hiddenFld.'" dialogWidth="'.$dialogWidth.'">
