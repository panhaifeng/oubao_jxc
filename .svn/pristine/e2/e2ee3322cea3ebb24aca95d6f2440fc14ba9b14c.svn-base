...
<table width="710px"  border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <table  class="tablec"  align="center" cellpadding="0" cellspacing="0" >
        <tr class="top">
            <td width="160" class="left">供应商名称</td>
        ...
        <tr >
            ...
            <td width="171" >收货人</td>
            <td width="92">{$rowset.0.people|default:'&nbsp;'}</td>
        </tr>
        <tr>
            <td width="160"  class="left">收货地址</td>
            <td colspan="5"  align="center">{$rowset.0.address|default:'&nbsp;'}</td>
            <td width="171" >收货单位 联系电话</td>
            <td width="92">{$rowset.0.tel|default:'&nbsp;'}</td>
        </tr>
        ...
        <tr>
            <td width="92" valign="center"  height="50" class="left">批号</td>
            <td width="160" valign="center" height="50" >花型六位号<br/>Pattern SN</td>
        ...
        <tr>
            <td width="92" valign="center" class="left">{$item.millNo}</td>
            <td width="160" valign="center" >{$item.productId}</td>
            <td width="84" valign="center"></td>
            <td width="84" valign="center">{$item.productId}</td>
        ...
        <tr>
            ...
            <td width="92" valign="center"></td>
            <td width="171" valign="center">{$heji.cnt|default:'&nbsp;'}M</td>
        </tr>
</table>
<table border="0px" width="710px">
        ...
        <tr>
            <td align="left" width="20%">打印人:<font style="padding-left:15px; padding-right:15px;">{$rowset.0.person|default:'&nbsp;'}</font></td>
