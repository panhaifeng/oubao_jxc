    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            <div class="form-control bottom-5">
                ...
                <input type="checkbox" name='docheck[]' value='{$madan.id}' cntMi='{$madan.cntMi}' danjia='{$madan.danjia}' style="width:15px;height:15px;" {if $madan.checked}checked{/if} {if $madan.disabled}disabled{/if}>
                </p>
            </div>
        </div>
        {/foreach}
